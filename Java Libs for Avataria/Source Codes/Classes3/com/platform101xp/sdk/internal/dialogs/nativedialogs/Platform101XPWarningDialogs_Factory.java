...
public final class Platform101XPWarningDialogs_Factory implements Factory<Platform101XPWarningDialogs> {
    ...
    public Platform101XPWarningDialogs_Factory(Provider<Platform101XPDialogCreator> provider, Provider<Platform101XPDialogCreator> provider2) {
        this.dialogCreatorProvider = provider;
        this.p0Provider = provider2;
    }

    public Platform101XPWarningDialogs get() {
        Platform101XPWarningDialogs newInstance = newInstance((Platform101XPDialogCreator) this.dialogCreatorProvider.get());
        Platform101XPWarningDialogs_MembersInjector.injectSetDialogCreator(newInstance, (Platform101XPDialogCreator) this.p0Provider.get());
        return newInstance;
    }

    public static Platform101XPWarningDialogs_Factory create(Provider<Platform101XPDialogCreator> provider, Provider<Platform101XPDialogCreator> provider2) {
        return new Platform101XPWarningDialogs_Factory(provider, provider2);
    }
